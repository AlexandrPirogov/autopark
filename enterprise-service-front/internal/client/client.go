...
// Lists brandss
const RegisterEnterpriseURL = "/api-enterprise/register"
const RegisterEnterpriseManagerURL = "/api-enterprise/register/manager"
const ListEnterprisesURL = "/api-enterprise/list"
const EnterpriseByTitle = "/api-enterprise/read/"
